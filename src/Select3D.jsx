...
const Select3D = () => {
  ...
  return (
    <div>
        <div className="max-w-5xl m-auto h-fit my-auto grid grid-cols-12 z-[20] relative" >
        ...
        `}
          ...
          <img src="/assets/3d-cover-1.png" className="rounded-3xl ease-in-out duration-300 rounded-b-none"
          data-aos="fade-up" data-aos-delay="300"/>
            <div className="w-full bg-white py-2 rounded-b-xl" data-aos="fade-up" data-aos-delay="300">
        ...
        onClick={()=>{navigate("/moon-cycle")}}>
          <img src="/assets/3d-cover-2.png" className="rounded-3xl ease-in-out duration-300  rounded-b-none"
            data-aos="fade-up" data-aos-delay="300" />
            <div className="w-full bg-white py-2 rounded-b-xl" data-aos="fade-up" data-aos-delay="300">
        ...
        onClick={()=>{navigate("/life-cycle")}}>
          <img src="/assets/3d-cover-3.png" className="rounded-3xl ease-in-out duration-300  rounded-b-none"
            data-aos="fade-up" data-aos-delay="300" />
            <div className="w-full bg-white py-2 rounded-b-xl" data-aos="fade-up" data-aos-delay="300">
